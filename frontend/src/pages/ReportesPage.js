...
export default function ReportesPage() {
  ...
  const handleExportExcel = () => {
    switch (seccion) {
      case 'anual': doDownload(`${API_URL}/reportes/anual/${anio}/excel`, `informe_anual_${anio}.xlsx`); break;
      case 'expedientes': doDownload(`${API_URL}/reportes/expedientes/excel?anio=${anio}`, `reporte_expedientes_${anio}.xlsx`); break;
      case 'poi': doDownload(`${API_URL}/reportes/poi/excel?anio=${anio}`, `reporte_poi_${anio}.xlsx`); break;
      case 'pap': doDownload(`${API_URL}/reportes/pap/excel?anio=${anio}`, `reporte_pap_${anio}.xlsx`); break;
      default: break;
    }
  };
  ...
  const handleExportPDF = () => {
    switch (seccion) {
      case 'anual': doDownload(`${API_URL}/reportes/anual/${anio}/pdf`, `informe_anual_${anio}.html`); break;
      case 'expedientes': doDownload(`${API_URL}/reportes/expedientes/pdf?anio=${anio}`, `reporte_expedientes_${anio}.html`); break;
      case 'poi': doDownload(`${API_URL}/reportes/poi/pdf?anio=${anio}`, `reporte_poi_${anio}.html`); break;
      case 'pap': doDownload(`${API_URL}/reportes/pap/pdf?anio=${anio}`, `reporte_pap_${anio}.html`); break;
      default: break;
    }
  };
